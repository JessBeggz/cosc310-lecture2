...
Implement Cart so the example at the bottom of this file behaves correctly.
  ...
  add_item(item, qty=1)  add an item; if it is already in the cart, increase the quantity instead of adding a second line
...
class Cart:
    ...
    def add_item(self, item: dict, qty: int = 1) -> None:
        ...
        line = {"item_id": item["id"], "name": item["name"], "price": item["price"], "qty": qty}
